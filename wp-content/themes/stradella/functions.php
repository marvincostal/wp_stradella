...
function stradella_scripts() {
	...
	wp_enqueue_script( 'collapse', JS . '/bootstrap/collapse.js', 'jquery', null, true );
	...
	wp_enqueue_script( 'blueimp_js', JS . '/blueimp-gallery.min.js', 'jquery', null, true );
}
...
function stradella_styles() {
	...
	wp_enqueue_style( 'blueimp', CSS . '/blueimp-gallery.min.css', 'bootstrap', null);
}
